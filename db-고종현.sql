...
insert into 담당 values('s004','p004','2/1');
 select * from 담당;

insert into 강좌 values('c001','p001','강좌1',1,'2022-03-16 14:00~16:00','1호');
insert into 강좌 values('c002','p002','강좌2',2,'2022-03-16 16:00~18:00','2호');
insert into 강좌 values('c003','p003','강좌3',null,null,null);
insert into 강좌 values('c004','p004','강좌4',1,'2022-03-16 12:00~14:00','4호');
 select * from 강좌;

insert into 수강내역 values('A','B','C','D','A','B','s001','c001','p001');
insert into 수강내역 values('B','C','D','A','B','C','s002','c001','p001');
insert into 수강내역 values('C','D','A','B','C','D','s003','c002','p002');
insert into 수강내역 values(null,null,null,null,null,null,'s004','c002','p002');
 select * from 수강내역;

-- 4번 수강하지 않은 학생의 명단을 출력하시오
select 학생.학생번호 as 학번 , 학생.학생이름 as 성명
from 학생 join 수강내역 on 학생.학생번호=수강내역.학생번호
where 평점 is null;
